...
# Fetch full list of Pokémon names (limited to 2,000) and sort alphabetically
...
app.layout = html.Div([
    ...
    html.Button("Download CSV", id="download-button", style={"marginLeft": "10px"}),
    # Hidden div to store the fetched data
    dcc.Store(id="pokemon-data-store"),    #Stores the data local as a database
...
def update_results(n_clicks, p1, p2, p3, p4, p5):
    ...
    # Convert to a cleaner table using dash_table
    columns = [
        {"name": "Name", "id": "name"},
        {"name": "ID", "id": "id"},
...
def download_csv(n_clicks, data):
    if data:
        # Convert the list of dicts to a DataFrame and generate CSV
